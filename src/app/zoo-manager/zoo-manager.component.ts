...
export class ZooManagerComponent {
  ...
  totalAnimalInventory: Animal[] = [
    ...
    new Animal("Yellow Bird", "Big Bird", new Date(1969, 3, 20), "vegetarian", "Bird Cage", 2, "male", "children, singing, dancing, poetry", "when children don't' learn"),
    ...
    new Animal("Alien", "E.T.", new Date(1982, 5, 26), "vegetarian", "Space", 1, "female", "Reece's Pieces, hoodies, plants, phoning home", "alienation")
  ]
